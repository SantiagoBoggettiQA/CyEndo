...
describe('Test Suite', () => {
  ...
  it('Verificar alertas de valores minimos de precios', () => {
...
cy.get('#mat-mdc-error-3').should('contain.text', 'El valor debe ser mayor o igual a');
