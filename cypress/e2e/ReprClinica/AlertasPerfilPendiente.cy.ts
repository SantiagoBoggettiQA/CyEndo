...
describe('Test Suite', () => {
  ...
  it('Alertas faltantes de datos en formulario perfil pendiente', () => {
...
cy.get('[data-cy="button-save"] > .mdc-button__label').click();
cy.get('.ng-submitted').submit();
cy.get('.mt-4').should('contain.text', 'El formulario contiene errores');
