...
cy.get(':nth-child(2) > .fuse-vertical-navigation-item-wrapper > .mat-mdc-tooltip-trigger')
.click();
cy.get('.cdk-focused span').click();
cy.get('#mat-input-2').type('Miguel');cy.get(':nth-child(1) > .flex-col > .flex-auto > .div-list-treatments').should('contain.text', 'Miguel');
