...
cy.get(':nth-child(4) > .fuse-vertical-navigation-item-wrapper > .mat-mdc-tooltip-trigger').click();
cy.get(':nth-child(2) > .flex-col > .flex-auto > .div-list-clinics > .justify-end > .mat-mdc-tooltip-trigger > .mat-icon').click();
cy.get('.div-edit-clinics:nth-child(3) .text-bold').should('contain.text', 'Datos del Clinica');
