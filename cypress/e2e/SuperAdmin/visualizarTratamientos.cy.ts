...
cy.get(':nth-child(1) > .flex-col > .flex-auto > .div-list-treatmentTypes > .gap-3 > .mat-mdc-tooltip-trigger > .mat-icon').click();

cy.get('.mb-10 > .text-bold').should('contain.text', 'Actualizar el tipo de tratamiento');
